      ...
      $preco_total = $total_pedido*$preco_unitario;
               ...
               VALUES (:nome_pedido,:modelo_pedido,:data_pedido,:data_entrega,:ptamPP,:ptamP,:ptamM,:ptamG,:ptamGG,:total_pedido,:preco_unitario,:preco_total)";
                      ...
                      $result = $conect->prepare($cadastro);
                        ...
                        $result->bindParam(':preco_unitario',$preco_unitario,PDO::PARAM_INT);
                                ...
                                if ($ptamPP > $tamP || $ptamP > $tamPP || $ptamM > $tamM || $ptamG > $tamG || $ptamGG > $tamGG) {
            ...
            //var_dump($_FILES);
                                ...
                                try{
                                    ...
                                    $result->bindParam(':tamPP',$uptamPP,PDO::PARAM_STR);
                                    $result->bindParam(':tamP',$uptamP,PDO::PARAM_STR);
                                    $result->bindParam(':tamM',$uptamM,PDO::PARAM_STR);
                                    $result->bindParam(':tamG',$uptamG,PDO::PARAM_STR);
                                    $result->bindParam(':tamGG',$uptamGG,PDO::PARAM_STR);
                                ...
                                $update = "UPDATE tb_modelo SET dispon_cost=:dispon_cost WHERE nome_cost=:nome_pedido";
                                try{
                                    $result = $conect->prepare($update);
                                    $result-> bindParam(':id_modelo',$id_modelo,PDO::PARAM_INT);
