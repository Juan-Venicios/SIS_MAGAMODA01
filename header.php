...
<?php
		include_once('conect/conect.php');
      	...
      	$select = "SELECT * FROM tb_costureira WHERE email_cost=:emailUser AND senha_cost=:senhaUser  AND status=:status";
  ...
  <section id="container">
    <header class="header black-bg">
      ...
      <!--logo start-->
        ...
        <a href="home.php?acao=principal" class="logo">


   <b>MAGA<span>MODA</span></b>
    ...
    <aside>
      <div id="sidebar" class="nav-collapse ">
        ...
        <ul class="sidebar-menu" id="nav-accordion">
          <h5 class="centered"><a href="home.php?acao=perfil&upperfil=<?php echo $id_cost; ?>"> <?php echo $nome_cost;?> </a> </h5>
       
                          
                         

                          <li class="sub-menu">
                              <span><a href="home.php?acao=modeloTAB"> <i class="fa fa-users"></i>Modelos</a></span>        
                          </li>

                          <li class="sub-menu">
                              <span><a href="home.php?acao=pedidoTAB&cost=<?php echo $id_cost;?>"> <i class="fa fa-users"></i>Pedidos</a></span>        
                          </li>
